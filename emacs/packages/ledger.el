(use-package ledger-mode
  ...
  ;; 添加一些常用的报表命令
  (add-to-list 'ledger-reports '("expense" "ledger -f 2022.ledger balance ^expense and not '^Expense:Home:家庭资金池'"))
  (add-to-list 'ledger-reports '("4083" "ledger -f ~/Dropbox/Accounting/2022.ledger register ^Assets:Checking:尾号4083"))
  (add-to-list 'ledger-reports '("公司三餐" "ledger -f ~/Dropbox/Accounting/2022.ledger balance ^expense:food and tag 公司"))
  (add-to-list 'ledger-reports '("19国庆旅游" "ledger -f ~/Dropbox/Accounting/2022.ledger balance ^expense and tag '旅游'"))
  ...
  (add-to-list 'ledger-reports '("liabilities" "ledger -f ~/Dropbox/Accounting/2022.ledger register Liabilities"))
